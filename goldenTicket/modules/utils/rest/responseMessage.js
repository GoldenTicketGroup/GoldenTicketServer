module.exports = {
    ...
    CREATED_X: "X 성공",
        FAIL_CREATED_X: "X 작성 실패",
    READ_X_ALL: "X 전체 조회 성공",
        FAIL_READ_X_ALL: "X 전체 조회 실패",
    READ_X: "X 상세 조회 성공",
    READ_X_OFFLINE: "X 상세 조회 성공(비로그인)",
        FAIL_READ_X: "X 상세 조회 실패",
    UPDATED_X: "X 수정 성공",
        FAIL_UPDATED_X: "X 수정 실패",
    REMOVED_X: "X 삭제 성공",
        FAIL_REMOVED_X: "X 삭제 실패",
